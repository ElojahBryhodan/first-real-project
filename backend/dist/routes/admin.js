...
exports.adminRouter.get('/matches', auth_1.authMiddleware, admin_1.requireAdmin, async (_req, res, next) => {
    try {
...
exports.adminRouter.get('/users', auth_1.authMiddleware, admin_1.requireAdmin, async (_req, res, next) => {
    try {
...
exports.adminRouter.get('/config', auth_1.authMiddleware, admin_1.requireAdmin, async (_req, res, next) => {
    try {
...
const updateCommissionSchema = zod_1.z.object({
    commissionBps: zod_1.z.number().int().min(0).max(10000), // 0-100% in basis points
});
exports.adminRouter.put('/config/commission', auth_1.authMiddleware, admin_1.requireAdmin, async (req, res, next) => {
    try {
        const parsed = updateCommissionSchema.parse(req.body);
        // Update or create platform config (id is always 1)
        const config = await client_1.prisma.platformConfig.upsert({
            where: { id: 1 },
            update: {
...
exports.adminRouter.post('/matches/:id/resolve', auth_1.authMiddleware, admin_1.requireAdmin, async (req, res, next) => {
    try {
